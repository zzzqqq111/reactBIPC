...
class Indicators extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (instanceData.indicators && instanceData.indicators.length !== 0) {
      this.setState({
        selectedRowKeys: instanceData.indicators,
      });
    }
  }
  ...
  getContent = () => {
    ...
    const columns = [
      ...
      { title: '指标渠道', dataIndex: 'channel', width: '8%' },
